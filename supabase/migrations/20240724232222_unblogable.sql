...
ALTER DATABASE postgres SET datestyle = dmy;
...
ALTER TABLE "public"."boycotted_influencers" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."boycotted_influencers" TO "anon";
GRANT ALL ON TABLE "public"."boycotted_influencers" TO "authenticated";
GRANT ALL ON TABLE "public"."boycotted_influencers" TO "service_role";
